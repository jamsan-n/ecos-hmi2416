...
#define HACK_SDRAM_SIZE      0x04000000
#define HACK_SDRAM_MASK      0x03ffffff
#define HACK_SDRAM_PHYS_BASE 0x30000000

#define CYGARC_PHYSICAL_ADDRESS(_x_)  ((_x_ & HACK_SDRAM_MASK) + HACK_SDRAM_PHYS_BASE)
#endif
