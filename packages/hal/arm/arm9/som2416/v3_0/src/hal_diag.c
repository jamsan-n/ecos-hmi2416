...
#include <cyg/hal/s3c2416.h>           // platform definitions

//enable uart clk, and enalbe uart0,uart1, IO port.
void hal_platform_uart_int(){
	cyg_uint32 temp;
	rPCLKCON |= (0x1<<13) |0xf;		//enable pclk into uart
	rSCLKCON |= 0x1<<8;	//enable uart clk
	
	// select UART function
	temp = (rGPHCON & (~0xff )) | 0xaa;
...
//    HAL_WRITE_UINT32(base+OFS_UBRDIV,  (cyg_uint32)((FCLK/4)/16./CYGNUM_HAL_VIRTUAL_VECTOR_CONSOLE_CHANNEL_BAUD+0.5) -1);
	DIV_VAL = ((float)PCLK/16./CYGNUM_HAL_VIRTUAL_VECTOR_CONSOLE_CHANNEL_BAUD)-1;
	HAL_WRITE_UINT32(base+OFS_UBRDIV, (int)DIV_VAL);

	UDIV_SLOT = (int)( (DIV_VAL-(int)DIV_VAL)*16 );
	switch (UDIV_SLOT) {
	case 0 : HAL_WRITE_UINT32(base+OFS_UDIVSLOT,0); break;
	case 1 : HAL_WRITE_UINT32(base+OFS_UDIVSLOT, 0x0080); break;
	case 2 : HAL_WRITE_UINT32(base+OFS_UDIVSLOT, 0x0808); break;
	case 3 : HAL_WRITE_UINT32(base+OFS_UDIVSLOT, 0x0888); break;
	case 4 : HAL_WRITE_UINT32(base+OFS_UDIVSLOT, 0x2222); break;
	case 5 : HAL_WRITE_UINT32(base+OFS_UDIVSLOT, 0x4924); break;
	case 6 : HAL_WRITE_UINT32(base+OFS_UDIVSLOT, 0x4a52); break;
	case 7 : HAL_WRITE_UINT32(base+OFS_UDIVSLOT, 0x54aa); break;
	case 8 : HAL_WRITE_UINT32(base+OFS_UDIVSLOT, 0x5555); break;
	case 9 : HAL_WRITE_UINT32(base+OFS_UDIVSLOT, 0xd555); break;
	case 10 : HAL_WRITE_UINT32(base+OFS_UDIVSLOT, 0xd5d5); break;
	case 11 : HAL_WRITE_UINT32(base+OFS_UDIVSLOT, 0xddd5); break;
	case 12 : HAL_WRITE_UINT32(base+OFS_UDIVSLOT, 0xdddd); break;
	case 13 : HAL_WRITE_UINT32(base+OFS_UDIVSLOT, 0xdfdd); break;
	case 14 : HAL_WRITE_UINT32(base+OFS_UDIVSLOT, 0xdfdf); break;
	case 15 : HAL_WRITE_UINT32(base+OFS_UDIVSLOT, 0xffdf); break;
	}
